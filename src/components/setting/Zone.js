        ...
        <Card>
            <form>
                <div>
                    ...
                    <input type="number" className="form-control" value={update.name} required onChange={
                ...
                <button className="btn btn-primary mt-2" type="submit" onClick={(e) => e.preventDefault()}>Update</button>
            </form>
        </Card>
    );
};
